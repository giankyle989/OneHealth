...
const DiagnosisList = () => {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:5000/api/admin/diagnosis/get", headerToken)
      .then((res) => {
  ...
  const handleDelete = (id) => {
    ...
    axios
      .delete(`http://localhost:5000/api/admin/diagnosis/${id}`, headerToken)
      .then((res) => {
                ...
                <tbody>
                  {filteredDiagnoses.map((diagnosis) => (
                    <tr key={diagnosis._id}>
                      ...
                      <td className="py-2 px-4 border-b">
                        <button className="bg-red-500 text-white p-2 rounded-md hover:bg-red-600" onClick={() => handleDelete(diagnosis._id)}>Delete</button>
                      </td>
                    </tr>
                  ))}
                </tbody>
