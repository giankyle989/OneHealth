...
const ManageAnnouncement = () => {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:5000/api/admin/announcement/get")
      .then((res) => {
  ...
  const handleDelete = (id) => {
    ...
    axios
      .delete(`http://localhost:5000/api/admin/announcement/delete/${id}`, headerToken)
      .then((res) => {
                ...
                {announcements.length === 0 ? (
                  ...
                  announcements.map((announcement) => (
                    <tr key={announcement._id}>
                      ...
                      <td className="border text-center p-2">
                        <button className="px-4 py-2 bg-red-500 text-white rounded" onClick={() => handleDelete(announcement._id)}>
                          Delete
                        </button>
                      </td>
                    </tr>
